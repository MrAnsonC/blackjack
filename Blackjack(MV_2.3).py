...
class Player:
    ...
    def place_bet(self, amount, pp_amount, twenty_four_amount, royal_match_amount):
        self.current_bet = 0
        self.current_pp = 0
        self.current_21_p_3 = 0
        self.current_royal = 0
        T_bet = 0
        T_bet = amount + pp_amount + twenty_four_amount + royal_match_amount
        if T_bet > self.money:
...
if __name__ == "__main__":
    ...
    while True:
        if fst_log_in:
            ...
            while True:
                ...
                if result:
                    ...
                    block()
                    print("You must enter valid number: {1, 2, 3}")
                    block()
        ...
        if game.player.place_bet(bet_amount, pp_amount, Twenty4_amount, royal_match_amount):
            game.play_round()
        else:
            block()
